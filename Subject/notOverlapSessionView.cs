...
namespace Subject
{
    public partial class notOverlapSessionView : Form
    {
        ...
        public void display_parallelSessions()
        {
            ...
            cmd.CommandText = "select id,lec,subj,subCode,tag,grp from[notOverlapSessions]  ";
            cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            foreach (DataGridViewRow dr in dataGridView1.Rows)
            {
                if (bool.Parse(dr.Cells[0].Value.ToString()))
                {
                    ...
                    SqlCommand cmd = conn.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = " delete from[notOverlapSessions] where id ='" + id + "'";
                    cmd.ExecuteNonQuery();
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select id,lec,subj,subCode,tag,grp from [notOverlapSessions] where grp like'" + textBox1.Text + "%'";
            cmd.ExecuteNonQuery();
